export const SITE = {
  title: "Webomate｜用對話製作專屬官網，早鳥試用 0元",
  description: "用簡單對話製作專屬官網，早鳥試用 0元即可擁有。無需寫程式，描述需求就能建立專業網站。",
...
export const FEATURES = [
  ...
  { icon: "💰", title: "早鳥試用 0元", desc: "早鳥試用 0元，訂閱後即可建置你的官網。" },
] as const;
...
export const STEPS = [
  ...
  { num: "03", title: "確認並上線", desc: "預覽後確認，早鳥試用 0元即可擁有專屬官網與網址。" },
] as const;
